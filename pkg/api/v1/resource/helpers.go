...
func GetResourceRequestQuantity(pod *v1.Pod, resourceName v1.ResourceName) resource.Quantity {
	...
	case v1.ResourceMemory, v1.ResourceStorage, v1.ResourceEphemeralStorage, v1.ResourceEphemeralRBPS, v1.ResourceEphemeralRIOPS, v1.ResourceEphemeralWBPS, v1.ResourceEphemeralWIOPS:
...
func ExtractContainerResourceValue(fs *v1.ResourceFieldSelector, container *v1.Container) (string, error) {
	...
	case "requests.ephemeral-rbps":
		return convertResourceEphemeralRBPSToString(container.Resources.Requests.EphemeralRBPS(), divisor)
	case "requests.ephemeral-riops":
		return convertResourceEphemeralRIOPSToString(container.Resources.Requests.EphemeralRIOPS(), divisor)
	case "requests.ephemeral-wbps":
		return convertResourceEphemeralWBPSToString(container.Resources.Requests.EphemeralWBPS(), divisor)
	case "requests.ephemeral-wiops":
		return convertResourceEphemeralWIOPSToString(container.Resources.Requests.EphemeralWIOPS(), divisor)
	}
