...
var podComputeQuotaResources = sets.NewString(
	...
	string(core.ResourceEphemeralRBPS),
	string(core.ResourceEphemeralWBPS),
	string(core.ResourceEphemeralRIOPS),
	string(core.ResourceEphemeralWIOPS),
	string(core.ResourceLimitsCPU),
	string(core.ResourceLimitsMemory),
	string(core.ResourceLimitsEphemeralRBPS),
	string(core.ResourceLimitsEphemeralWBPS),
	string(core.ResourceLimitsEphemeralRIOPS),
	string(core.ResourceLimitsEphemeralWIOPS),
	string(core.ResourceRequestsCPU),
	string(core.ResourceRequestsMemory),
	string(core.ResourceRequestsEphemeralRBPS),
	string(core.ResourceRequestsEphemeralWBPS),
	string(core.ResourceRequestsEphemeralRIOPS),
	string(core.ResourceRequestsEphemeralWIOPS),
)
